...
/// <summary>
/// Validador para UpdateBlogPostCommand
/// Define todas as regras de validação para atualização de posts
...
public class UpdateBlogPostCommandValidator : AbstractValidator<UpdateBlogPostCommand>
{
    public UpdateBlogPostCommandValidator()
    {
        ...
        // VALIDAÇÃO DO ID
        // ====================================
        RuleFor(x => x.PostData.Id)
            .NotEmpty().WithMessage("O ID do post é obrigatório");
