// ====================================
// Título: UpdateGalleryImageCommandValidator.cs
// Descrição: Validações para atualização de imagem na galeria
// Autor: Will
// Empresa: WpDev
// Data: 06/12/2024
// ====================================
...
public class UpdateGalleryImageCommandValidator : AbstractValidator<UpdateGalleryImageCommand>
{
    public UpdateGalleryImageCommandValidator()
    {
        ...
        RuleFor(x => x.ImageData.FileSizeBytes)
            ...
            .LessThanOrEqualTo(10485760).WithMessage("O tamanho do arquivo deve ser no máximo 10MB");
