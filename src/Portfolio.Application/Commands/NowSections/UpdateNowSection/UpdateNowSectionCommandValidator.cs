// ====================================
// Título: UpdateNowSectionCommandValidator.cs
// Descrição: Validações para atualização de seção Now
// Autor: Will
// Empresa: WpDev
// Data: 06/12/2024
// ====================================
...
public class UpdateNowSectionCommandValidator : AbstractValidator<UpdateNowSectionCommand>
{
    public UpdateNowSectionCommandValidator()
    {
        RuleFor(x => x.SectionData.Id)
