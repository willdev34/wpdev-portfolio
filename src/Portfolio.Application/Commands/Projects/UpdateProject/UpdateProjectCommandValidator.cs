// ====================================
// Título: UpdateProjectCommandValidator.cs
// Descrição: Validações para atualização de projeto - Design Editorial
// ====================================
...
/// Mesmas regras do CreateProjectCommandValidator, mais validação do Id
...
public class UpdateProjectCommandValidator : AbstractValidator<UpdateProjectCommand>
{
    ...
    {
        // ====================================
        // VALIDAÇÃO DO ID (exclusivo do update)
        // ====================================
        RuleFor(x => x.ProjectData.Id)
